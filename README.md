...
- [ ] **Re-enable `TestimonialBlock`** — disabled site-wide pending real student quotes. The component still exists in the codebase; re-enable per-page once quotes are gathered and consent obtained.
