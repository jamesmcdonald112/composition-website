# Employment Law page
_Exported 1 May 2026 — source: `src/config/services/employment-law.ts`_

This document is the full content of the Employment Law service page on the Mary Molloy Solicitor website. The wording has been audited against the Legal Services Regulation Act 2015 (Advertising) Regulations 2020.
...
- **Title:** Practical employment law advice in Kilkenny
...
## Article — "How Irish employment law works"
...
> "Employment law has tighter deadlines than most people expect. The WRC's six-month rule is one of the most common reasons that otherwise good claims cannot be pursued — and it runs from the date of the act complained of, not from the end of any internal grievance process."
>
...
- **Working time and rest breaks** — The Organisation of Working Time Act 1997 sets out maximum working hours (48 hours per week averaged over a reference period), rest breaks, annual leave (four working weeks per year), and public holiday entitlements. Breaches can be referred to the WRC.
- **Payment of wages** — The Payment of Wages Act 1991 prohibits unlawful deductions from wages. Where an employer reduces pay without agreement, or makes deductions not authorised under the contract, that may be an unlawful deduction that can be referred to the WRC.

### Section: Advice for employers

> For employers, the cost of getting a dismissal or redundancy wrong can be significant — WRC awards, legal costs, and the disruption of contested proceedings all add up. We advise businesses on putting in place clear, compliant employment contracts, disciplinary and grievance procedures, and performance-management frameworks before issues arise.

> Where a disciplinary or redundancy process is required, we advise on how to manage it in line with the relevant statute and case law — appropriate notice, a genuine opportunity to respond, a fair investigation, and a right of appeal. Following the correct procedure is both a legal requirement and the fairest way to handle a difficult situation. It is also, in practical terms, what an adjudicator looks at first.

### Section: Time limits for WRC complaints
...
1. **Initial consultation** — We review the employment situation — the contract, the relevant correspondence, and the circumstances of the dismissal or dispute — and advise the client honestly on whether there is a viable claim, what process applies, and what steps to take next.
2. **Internal grievance and appeal** — Where a dismissal or disciplinary decision has been made, we advise on whether internal grievance or appeal procedures should be exhausted first. Pursuing internal routes is often a prerequisite for WRC claims and can sometimes lead to a resolution without formal proceedings.
3. **WRC complaint** — We prepare and submit the complaint to the Workplace Relations Commission, gather the necessary supporting evidence and documentation, and represent the client at the WRC adjudication hearing. We advise on the strengths and weaknesses of the case throughout.
4. **Appeal and enforcement** — Where the WRC issues a decision, we advise on what the decision means in practical terms, on whether an appeal to the Labour Court is appropriate, and on the steps available to enforce the decision if the other party does not comply.

---

## Bottom call to action

- **Title:** A clear assessment of your employment law matter
...
**1. What is constructive dismissal in Irish law?**
...
**2. How long does an employee have to make a WRC complaint?**
...
**3. Who is entitled to statutory redundancy pay?**
...
**4. Can an employer change a contract without the employee's agreement?**
...
**5. What does the WRC process involve?**
...
**6. What should an employer do on receiving a WRC complaint?**
...
This page was audited against the Legal Services Regulation Act 2015 (Advertising) Regulations 2020 and was rewritten in full from the previous version to remove urgency and encouragement framing.

**Regulations reviewed:**

- **Reg 4(a)(i)** — likely to bring the profession into disrepute. The previous urgent-advocacy register (*"Time limits apply — act now"*, *"Get advice now"*, *"act promptly"*) was rewritten into calm, descriptive language consistent with the rest of the site.
- **Reg 4(a)(ii)** — likely to be in bad taste. No issues — employment law copy does not lend itself to dark humour.
- **Reg 4(a)(iii)** — likely to constitute an attack on another solicitor. No comparative or critical wording about other firms.
- **Reg 4(a)(iv)** — likely to be false or misleading. The previous *"represent your interests effectively"* and *"significantly reduces the risk of a successful WRC claim"* phrasing implied outcome influence and was rewritten. The previous *"currently €600 per week"* statutory cap figure was replaced with *"a statutory weekly earnings cap"* — the cap is set by statute and changes; hardcoding the figure risked the page going stale.
- **Reg 4(a)(vi)** — likely to encourage a person to make a claim. The previous version contained six separate prompts to act/contact/call (*"Time limits apply — act now"*, *"Get advice now"*, *"contact us without delay"*, *"act promptly"*, *"contact us as soon as possible"*, *"before the clock runs out"*). All have been removed. The six-month WRC time limit is now stated factually inside the article body, not used in CTAs.
- **Reg 5(a)(i)** — consent to refer to a person. Nicholas O'Shea is named in a pull quote on the page. Consent for in-house solicitors named on the website is covered by a single signed blanket consent form held by the firm. _Action item — see below._
- **Reg 6(a)** — cost warning. Employment law matters at the WRC are contentious business; the firm's standard cost warning lives in the legal cost notice and the site-wide footer.
- **Reg 6(b)** — no-win-no-fee ban. Not directly applicable on this page; no fee-related wording appears.
- **Reg 6(c)** — referring to compensation amounts. The two-year remuneration cap on WRC awards is a statutory maximum, not a firm-quoted figure. No specific compensation amounts are stated.
- **Reg 7** — claims of risk-free litigation. No language suggesting WRC proceedings are risk-free or guaranteed.
...
- **Nicholas O'Shea pull quote — Reg 5(a)(i) consent** — needs the same firm-wide blanket consent form Richard signed (name, role, photo, bio, all pull quotes attributed to him on the website). No content change required on the page; this is a paperwork item only.
