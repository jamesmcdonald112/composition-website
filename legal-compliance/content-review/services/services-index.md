...
- **Reg 5(a)(i)** — consent to refer to a person. Mary Molloy is named as the firm's principal solicitor; her name and likeness on the firm's own website does not require separate consent (Category 1 in `legal-compliance/testimonials-and-quotes-consent.md`). Nicholas O'Shea and Richard O'Shea are named as solicitors at the firm — covered by the firm-wide blanket consent forms they have signed. No content change required; no action item.
