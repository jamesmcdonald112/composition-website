# Road Traffic Accidents page
_Exported 1 May 2026 — source: `src/config/services/road-traffic-accidents.ts`_

This document is the full content of the Road Traffic Accidents service page on the Mary Molloy Solicitor website. The wording has been audited against the Legal Services Regulation Act 2015 (Advertising) Regulations 2020.
...
- **Page title:** Road Traffic Accident Solicitors Kilkenny | Mary Molloy Solicitor
- **Meta description:** Road traffic accident solicitors in Kilkenny. We advise clients on liability, the PIAB process, dealings with insurers, and the conduct of personal injury claims arising from road traffic accidents.
...
- **Title:** A clear path through your road traffic claim
...
| Established | 1979 |
| Local base | Kilkenny |
| Focus area | Road Traffic Claims |

---

## Article — "How a road traffic claim works in Ireland"
...
### Section: What evidence supports a road traffic claim
...
### Section: How compensation is calculated

- **General damages** — Compensation for the pain, suffering, and impact on quality of life caused by the injuries. The amount is assessed by reference to the Personal Injuries Guidelines published by the Judicial Council in 2021, which set out appropriate damages ranges for common injury types.
- **Loss of earnings** — Where injuries prevent a claimant from working, or affect future earning capacity, that loss is recoverable. We gather payslips, medical evidence, and where appropriate reports from occupational or vocational experts to establish and value this element of a claim.
- **Medical and rehabilitation costs** — The cost of GP visits, hospital treatment, physiotherapy, specialist appointments, prescribed medication, and any aids or adaptations required as a result of the injuries are all recoverable as special damages.
- **Future losses** — In cases of serious injury, compensation can also include the cost of future medical treatment, ongoing care needs, and the long-term impact of the injury on earning capacity. Appropriate experts are engaged to establish and quantify these losses.
- **Out-of-pocket expenses** — Travel costs to and from medical appointments, care provided by a family member or friend, and other reasonably incurred expenses can be claimed as part of a road traffic accident case.

### Section: How PIAB fits in
...
### Section: Uninsured drivers and the MIBI scheme
...
### Section: How long a road traffic claim takes
...
### Section: The time limit on a road traffic claim
...
- **Title:** A clear assessment of your road traffic claim
...
**1. What is the time limit for a road traffic accident claim?**
...
**2. What if the other driver was uninsured or could not be identified?**
...
**3. What about an early settlement offer from an insurance company?**
...
**4. How long does a road traffic accident claim take?**
...
**5. Is vehicle damage covered as well as personal injury?**
...
This page was audited against the Legal Services Regulation Act 2015 (Advertising) Regulations 2020 and was rewritten in full from the previous version to remove urgency and adversarial framing.

**Regulations reviewed:**

- **Reg 4(a)(i)** — likely to bring the profession into disrepute. *"On your side from the moment you call"*, *"levels the playing field"* and similar combative slogans were removed in favour of descriptive, calm-authority framing.
- **Reg 4(a)(ii)** — likely to be in bad taste. The previous "straightforward whiplash claims" wording, which could read as dismissive of a real injury type, was rewritten.
- **Reg 4(a)(iii)** — likely to constitute an attack on another solicitor or insurance party. Wording that implied bad faith on the part of insurers (e.g. *"We level the playing field — giving you experienced legal representation"*, *"Don't deal with insurers alone"*) was rewritten to describe the firm's process without coded criticism of insurers.
- **Reg 4(a)(iv)** — likely to be false or misleading. No specific success-rate or settlement-figure claims are made. Statements about timelines (twelve to eighteen months) are framed as typical ranges, not promises.
- **Reg 4(a)(vi)** — likely to encourage a person to make a claim. The previous *"Injured? Don't deal with insurers alone"* hooks were removed. The two-year time limit is now stated factually inside the article, not used in a CTA.
...
- **Reg 6(a)** — cost warning. Not directly applicable on this page; the firm's standard cost warning lives in the legal cost notice.
- **Reg 6(b)** — no-win-no-fee ban. No no-win-no-fee or contingency-fee wording appears anywhere on the page.
- **Reg 6(c)** — referring to compensation amounts. Damages are described by reference to the Personal Injuries Guidelines published by the Judicial Council in 2021, the lawful basis for general damages assessment. No specific compensation figures are stated.
- **Reg 7** — claims of risk-free litigation. No language suggesting a claim is risk-free, easy, or guaranteed appears.
...
- `.claude/skills/copy/SKILL.md` — voice, plain-English structure, Mary's calm-authority register
