# Website Disclaimer — Mary Molloy Solicitor

_This is the source-of-truth markdown for the live `/disclaimer` page. The page is rendered from `src/config/legal/disclaimer.ts`. **Keep both files in sync** — when one is updated, update the other and bump the "Last reviewed" date._

_Research, Law Society template comparison, and Regulation 9 reasoning behind this content live in `legal-compliance/disclaimer/disclaimer-research-and-audit-trail.md`._

_**Reuse note:** the disclaimer is firm-agnostic apart from the firm name. Wherever the markdown below names "Mary Molloy Solicitor" (Sections 2 and 7), the rendered TS config interpolates `firm.companyName` from `src/config/firm.ts` at build time. To reuse this disclaimer on another Irish solicitor's website, copy `src/config/legal/disclaimer.ts` and `src/config/firm.ts` (with the new firm's details) — no edits needed to the disclaimer config itself. The Irish statutory anchors apply equally to any Irish firm._
...
Reading this website, contacting us through the contact form, or sending us an email **does not** create a solicitor–client relationship between you and Mary Molloy Solicitor. A solicitor–client relationship is created only when:
...
## 3. Confidentiality of pre-engagement communications

Any information you send to the firm before a retainer is in place is treated confidentially in the ordinary course of professional handling. However, **solicitor–client privilege** applies only once a solicitor–client relationship exists (see Section 2 above). Until then, communications attract the firm's professional duty of confidentiality but do not enjoy the legal privilege that protects later, retained-relationship communications. If your communication is sensitive, we recommend that you do not include detailed factual content in a contact-form message until you have an engagement letter in place.

This point is also covered in our [Privacy Policy](/privacy), Section 8.

---

## 4. Accuracy and currency of content

We take care to make sure that the information on this site is accurate and up to date at the date of publication. However:
...
This site contains a small number of links to external websites operated by third parties. The destinations are limited to **informational and regulatory sources** — for example, the Law Society of Ireland, the Legal Services Regulatory Authority, the Data Protection Commission, the Courts Service of Ireland, the Irish Statute Book, and Google Maps for directions to the office.

The firm chooses these destinations carefully and audits each link before publication. The firm does **not** link to:
...
This site is provided for personal, non-commercial use. You may read the pages, save them for your own reference, and share links to specific pages. You may **not**:
...
All content on this site — including text, images, page layout, and design — is owned by Mary Molloy Solicitor or used with permission, and is protected by trade mark, copyright, and other intellectual property laws. The firm name "Mary Molloy Solicitor" and any associated identifiers are protected. None of this content may be reproduced without our prior written consent. Nothing on this site grants you any right or licence to use any of the content, name, or marks except for the personal-use purposes set out in Section 6.

---

## 8. The site may change without notice

We may change, add to, remove from, or discontinue any part of this website at any time and without notice. We may also change this disclaimer from time to time. The "Last reviewed" date at the top of this page shows when it was last revised. Please check this page periodically — your continued use of the site after a change indicates your acceptance of the updated disclaimer.

---

## 9. Governing law and jurisdiction

This disclaimer, your use of this site, and any dispute arising out of or in connection with either of them is governed by the **laws of Ireland**. The courts of Ireland have **exclusive jurisdiction** over any such dispute.
