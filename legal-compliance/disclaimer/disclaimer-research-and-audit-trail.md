...
_The research, comparison work, and editorial reasoning behind the live disclaimer at `/disclaimer`. The published prose lives in `legal-compliance/disclaimer/disclaimer.md`; the rendering config lives in `src/config/legal/disclaimer.ts`._
...
3. **Stage 3 — Law Society template comparison** — the official Law Society of Ireland template (`legal-compliance/disclaimer/law-society-of-ireland-website-disclaimer-template.docx`) was read end-to-end and compared section by section against Stage 1.
...
| 5 — External links | Reg 9 LSRA 2020 — solicitor deemed responsible for promotional content on linked external pages | LSRA 2020 Reg 9; mirrors `legal-compliance/legal-services-regulation-act/website-content-review-checklist.md` Reg 9 audit policy |
...
_Done 2026-05-04. Template filed at `legal-compliance/disclaimer/law-society-of-ireland-website-disclaimer-template.docx`._
...
_Source: `legal-compliance/legal-services-regulation-act/legal-services-regulation-act-2015-advertising-regulations-2020.md`, Regulation 9._
...
This is consistent with the existing audit-trail policy in `legal-compliance/legal-services-regulation-act/website-content-review-checklist.md` Section "Reg 9 — You are responsible for linked external content".
...
- `src/config/legal/disclaimer.ts` — rendering config (translated from `legal-compliance/disclaimer/disclaimer.md`)
...
- `legal-compliance/disclaimer/disclaimer.md` — published source-of-truth markdown
- `legal-compliance/disclaimer/law-society-of-ireland-website-disclaimer-template.docx` — Law Society template used for Stage 3 comparison
- `legal-compliance/gdpr/privacy-policy-draft.md` — Section 8 (privilege) cross-referenced in disclaimer Section 3
- `legal-compliance/legal-services-regulation-act/legal-services-regulation-act-2015-advertising-regulations-2020.md` — content-restriction regime; **Reg 9 is the basis for Section 5**
- `legal-compliance/legal-services-regulation-act/website-content-review-checklist.md` — existing Reg 9 audit policy, mirrored in disclaimer Section 5
...
- **When law changes:** update the relevant section, bump the "Last reviewed" date in `legal-compliance/disclaimer/disclaimer.md` and `src/config/legal/disclaimer.ts`, run the compliance screenshot.
