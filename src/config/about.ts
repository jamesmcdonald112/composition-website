...
export const aboutPageContent = {
	seo: {
		title: `About Mary Molloy Solicitor | Kilkenny Law Firm Since ${firm.established}`,
		description: `Mary Molloy Solicitor has practised in Kilkenny since ${firm.established}. A family firm handling property, wills, family law, personal injury and private client matters.`,
		canonicalPath: "/about",
	},
	hero: {
	...
	trustStrip: {
		...
		paragraphs: [
			`Mary Molloy has been practising law in Kilkenny since ${firm.established}. What started as a sole practice on Rose Inn Street is now a three-solicitor family firm. Mary's sons Nicholas and Richard practise alongside her, each with their own area of focus and the same approach the firm was built on.`,
