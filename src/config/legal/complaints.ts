...
export const complaintsPageContent: LegalPageContent = {
	seo: {
	...
	sections: [
		{
			...
			body: "If you are dissatisfied with the legal services provided by this firm, the following steps apply:",
			list: [
		...
		},
		{
			...
			body: "If you wish to dispute this bill of costs, or any part of it you can avail of the following procedure:",
			list: [
			...
			afterListBody: "In the event our bill or any part of our bill remains unpaid by 30 days from date of bill of costs, we may make an application to have our bill adjudicated by the Legal Costs Adjudicator."
		}
	],
};
