...
export const leadMagnet: LeadMagnetContent = {
	...
	form: {
		...
		body: "Occasional letters from the studio — essays on harmony, counterpoint, and the craft of composition; news about new lessons, courses, recordings, and resources as they become available; and the occasional update on the studio itself. As a welcome, you'll receive a free nine-page guide on how to choose a composition teacher.",
		bullets: [
			"Six questions to ask any prospective composition teacher (in the welcome guide)",
			"News and availability when new lessons, courses, or resources are released",
			"Occasional writing on the conservatoire curriculum — harmony, counterpoint, orchestration, and the rest",
		],
