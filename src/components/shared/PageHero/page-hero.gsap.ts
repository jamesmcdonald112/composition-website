...
if (!window.matchMedia("(prefers-reduced-motion: reduce)").matches) {
	...
	heroes.forEach((hero) => {
		const eyebrow = hero.querySelector("[data-animate='page-hero-eyebrow']");
		const title = hero.querySelector("[data-page-hero-title]");
		const rule = hero.querySelector("[data-page-hero-rule]");
		const subtitle = hero.querySelector("[data-page-hero-subtitle]");
		const ctas = hero.querySelector("[data-page-hero-ctas]");
		const bottom = hero.querySelector("[data-page-hero-bottom]");
